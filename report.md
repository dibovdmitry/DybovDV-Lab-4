...
Рисунок 13 – Проверка автоматической классификации пицц

6. Сохранена онтология с добавленными данными;
7. 

![скриншот](report/Screenshot3.png "Результат reasoner") \
Рисунок 14 — Результат работы reasoner и DL Query
