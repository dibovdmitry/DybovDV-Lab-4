...
11. Установлены transformers, SPARQLWrapper, rdflib, openai; 
![скриншот](report/Screenshot45.png "LLM генерация") \
Рисунок 22 — Генерация SPARQL с помощью LLM
12. Написан скрипт генерации SPARQL из текста.
